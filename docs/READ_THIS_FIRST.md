...
You arrived at a repo with 16 docs, 6 hooks, 5 tools, a Constitution,
and a falsifiability framework. That is a substantial surface area
for a first visit.

Below is the minimum needed to decide whether to invest further.

## What this is, in plain English

Claude Code charges you for every word it sees, every turn. This repo
contains hooks (6 small bash files) that watch your usage, log it, and
...
| See an example operator's 90-day data | `examples/case-study-2026-04-28/` |
| Live with it day-to-day after install | `docs/HANDBOOK.md` |
