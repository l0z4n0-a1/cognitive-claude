...
If your output matches the "🟢 GREEN" pattern across all five, the install
will move ~1-3% on your bottleneck. **Save your time; read
`docs/ARCHITECTURE.md` for the principles, skip the install.**
