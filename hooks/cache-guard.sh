...
#
# Input contract: Claude Code passes a JSON record on stdin with
# fields {tool_name, tool_input, ...}. We read stdin, parse with
# python3, and inspect the relevant fields for the matched tool.
